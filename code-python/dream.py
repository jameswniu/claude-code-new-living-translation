"""
Claude Code dream/memory consolidation system.
...
def build_dream_prompt(memory_dir: str, transcripts_dir: str, extra_context: str = "") -> str:
    """Build the 4-phase dream consolidation prompt."""
